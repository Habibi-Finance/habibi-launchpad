...
contract Habibi20 is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address taxAccount, uint256 maxTaxAmount, uint256 buyTaxAmount, uint256 sellTaxAmount, address swapRouter, uint256 preMint, uint256 maxBuyAmount) ERC20("Habibi 2.0", "HABB") {
